 ...
 *   2. estimatedSeconds, from word count at ~130 wpm
 *
...
export const blocks: Block[] = [
  ...
  },
  {
    ...
    wordCount: 130,
    narration:
      "Before ASC 606, construction accounting lived in its own neighborhood. [[r]] ASC 605-35 gave contractors a purpose-built model, and the central question was which of two methods you qualified for. [[r]] Percentage of completion, if you could make dependable estimates. [[r]] Completed contract, if you could not. Once you chose percentage of completion, the machinery followed: measure progress, usually with cost-to-cost, recognize revenue and gross profit in proportion, and carry the difference between what you had earned and what you had billed as [[r]] costs in excess of billings, or billings in excess of costs. Every contractor's balance sheet had those two lines. Every surety underwriter knew how to read them. [[r]] ASC 606 took that neighborhood apart. Not because it was wrong — because it was separate.",
  ...
  },
  {
    ...
    wordCount: 175,
    narration:
      "Step five is where contractors feel the change, so let's be precise about what it does. [[r]] Step five asks whether a performance obligation is satisfied over time or at a point in time. [[r]] Point in time is the default. [[r]] Over time is the exception, and you have to earn it. Notice what that is not. It is not a choice. [[r]] You do not elect over-time recognition because it produces better financial statements, or because it is what you have always done, or because your bank expects it. You test the performance obligation against criteria in the standard, and the criteria decide. ASC 606-10-25-27 gives three criteria. [[r]] Meeting any one of them means the obligation is satisfied over time. Fail all three, and revenue goes at a point in time — which for a two-year construction contract would mean nothing until the end. Most construction contracts do meet one of them. But most is doing real work in that sentence, and the exceptions are where practitioners get surprised.",
  ...
  },
  {
    ...
    wordCount: 205,
    narration:
      "The three criteria in 25-27, briefly. [[r]] The first: the customer simultaneously receives and consumes the benefits as you perform. That fits routine services — a monthly cleaning contract. It rarely fits construction, because nobody consumes a half-built bridge. [[r]] The second: your performance creates or enhances an asset the customer controls as it is created. This one fits construction on the customer's own land, and it is often the cleanest fit for a general contractor building on an owner's site. [[r]] The third: your performance creates an asset with no alternative use to you, and you have an enforceable right to payment for performance completed to date. This is the criterion most construction contracts land on, and it is the one worth memorizing, because [[r]] both halves have to hold. No alternative use means you could not practically redirect the asset to another customer. A custom facility, yes. Speculative homes built to a standard plan, often no. Enforceable right to payment means that if the customer terminated for convenience tomorrow, you could enforce payment for work performed plus a reasonable margin — [[r]] not just recover your costs. That is a contract-terms question, and it is jurisdiction-specific.",
  ...
  },
  {
    ...
    wordCount: 185,
    narration:
      "Now the part that gets collapsed most often. Concluding that a performance obligation is satisfied over time does not tell you how much revenue to recognize. [[r]] That is a second, separate decision: selecting a method to measure progress toward complete satisfaction of the obligation. ASC 606 offers input methods and output methods. [[r]] Input methods measure your efforts — costs incurred, labor hours, machine hours. [[r]] Output methods measure results — units delivered, milestones reached, surveys of performance completed. [[r]] Cost-to-cost is an input method. It is the one most contractors use, and if you have been doing percentage of completion by cost-to-cost, your spreadsheet may barely change. But the reasoning underneath it changed completely, and that matters when the facts get unusual. [[r]] You are no longer applying a method you elected. You are selecting a measure that faithfully depicts your progress toward transferring control — and the standard will tell you, in specific circumstances, that your familiar cost-to-cost measure does not depict it faithfully and must be adjusted. Uninstalled materials is the clearest example. That is lesson three.",
  ...
  },
  {
    ...
    wordCount: 120,
    narration:
      "So here is the shape of it. Percentage of completion was one method you elected. What replaced it is two sequential judgments: [[r]] first, does this performance obligation qualify for over-time recognition under one of the three criteria — [[r]] and second, what measure of progress faithfully depicts the transfer of control. Same spreadsheet, often. Different reasoning, always. And when a contract is unusual — an odd termination clause, a spec build, a large equipment purchase sitting on site — the two judgments can pull apart in ways the old single election never could. [[r]] Next lesson, we go back a step, to the question that has to be answered before either of these: what exactly is the performance obligation in a construction contract?",
    reveals: [6, 18, 34],
  },
];
